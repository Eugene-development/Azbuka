const title_Marketing_v5 = 'Установка'
const text_Marketing_v5 = 'Соберём и установим ваш шкаф-купе или кухонный гарнитур руками квалифицированных специалистов. На работы предоставляется дополнительная гарантия.'
