...
const text_Marketing_v5 = 'Привозим мебель своим транспортом до адреса заказчика. Есть услуга подъёма на этаж грузчиками. Также вы можете забрать заказ самовывозом.'
