const title_Marketing_v5 = 'Оплата'
const text_Marketing_v5 = 'Предлагаем удобные способы оплаты наличным или безналичным способом. На заказные позиции работаем по предоплате. Возможна оплата через сайт.'
